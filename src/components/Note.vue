<template>
    <div class=" bg-amber-200 rounded  text-center text-fuchsia-900 p-2 space-y-2">
        ...
        <div class="flex justify-around ">
            <button @click="editNote(note)" class="hover:bg-green-300"><flat-color-icons:edit-image/> </button>

            <button @click="removeNote($props.note.id)" class="hover:bg-red-100"><flat-color-icons:delete-row/> </button>
        </div>
